...
<head>
	<meta charset="UTF-8">
	<meta name="google-site-verification" content="H_Bh53g4jmnfXzZnYZREQWoAnCBKM9EAhiwZH6fU7b4" />
	<link rel="icon" type="image/png" href="img/favicon.png" />
	<title>NOKIN</title>
	 <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0"> 
  	<META NAME="Title" content="Nokin">
  	<META NAME="Author" CONTENT="[http://nokinservicios.com/]"/>
